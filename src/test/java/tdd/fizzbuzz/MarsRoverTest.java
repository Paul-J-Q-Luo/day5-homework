...
class MarsRoverTest {
    ...
    @Test
    public void should_return_location_is_N_and_x_is_0_and_y_is_nav_1_when_given_direction_is_N_and_command_is_B_and_x_is_0_and_y_is_0() {
        String direction = "N";
        String command = "B";
        int x = 0;
        int y = 0;
    ...
    @Test
    public void should_return_location_is_S_and_x_is_0_and_y_1_when_given_direction_is_S_and_command_is_B_and_x_is_0_and_y_is_0() {
        String direction = "S";
        String command = "B";
        int x = 0;
        int y = 0;
    ...
    @Test
    public void should_return_location_is_W_and_x_is_1_and_y_0_when_given_direction_is_W_and_command_is_B_and_x_is_0_and_y_is_0() {
        String direction = "W";
        String command = "B";
        int x = 0;
        int y = 0;
    ...
    @Test
    public void should_return_location_is_W_and_x_is_nav_1_and_y_0_when_given_direction_is_N_and_batch_command_is_LM_and_x_is_0_and_y_is_0() {
        String direction = "N";
        String command = "LM";
        int x = 0;
        int y = 0;
